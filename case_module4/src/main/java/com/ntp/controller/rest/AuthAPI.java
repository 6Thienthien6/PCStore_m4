...
import com.ntp.exception.DataInputException;
import com.ntp.exception.EmailExistsException;
import com.ntp.model.JwtResponse;
import com.ntp.model.Role;
import com.ntp.model.User;
import com.ntp.model.dto.UserDTO;
import com.ntp.service.jwt.JwtService;
import com.ntp.service.role.IRoleService;
import com.ntp.service.user.IUserService;
import com.ntp.utils.AppUtil;
...
public class AuthAPI {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody UserDTO userDTO, BindingResult bindingResult) {
        ...
        Optional<UserDTO> phoneUser = userService.findUserDTOByUserPhone(userDTO.getPhone());

        if (phoneUser.isPresent()) {
            throw new EmailExistsException("Phone already exists");
        }
